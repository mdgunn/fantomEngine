...
Class cGame Extends App
	...
	Method OnCreate:Int()
		...
		CreatePlayer()
#rem	
Print( "autofitX : " + fE.autofitX )
Print( "autofitY : " + fE.autofitY )
Print( "canvasWidth : " + fE.canvasWidth )
Print( "canvasHeight : " + fE.canvasHeight )
Print( "scaleX : " + fE.scaleX )
Print( "scaleY : " + fE.scaleY )
Print( "scissorOffWidth : " + defLayer.scissorOffWidth )
Print( "scissorOffHeight : " + defLayer.scissorOffHeight )
Print( "------------------------------" )
#end
